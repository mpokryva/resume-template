---
layout: post
title: "Yep, another interview guide"
...
The problem with this approach is that the "Slava Method" (™) is a really rough proxy for IQ, but it generally works since most people would agree that if someone can destroy a LeetCode hard in 15 minutes they're probably pretty smart. If they do it a few more times then you know they aren't cheating. And if you're in the camp that says "Anyone can do that if they grind enough!" then you have to ask yourself if you believe that a meaningfully large number of people are grinding algorithm problems to the level where they consistently finish LeetCode hards in 15 minutes. 

Anyways, once you crank up 15 minutes to 50, you change the question from "Are they very smart?" to "How smart are they?" I don't believe you can answer this question efficiently via standard algorithm interviews. LeetCode questions provide only as much resolution as the evaluation rubric you create and since LeetCode questions rarely map to actual job requirements, it's virtually impossible to create a sensible rubric. 

So, if you don't need a crazy talented engineer, this guide's for you. Keep in mind that I'm just another engineer with another opinion, so what do I know... Still, maybe you'll find something you like here, or even better, reading this may serve as an outlet for your anger on Hacker News. [Win-win-win](https://www.youtube.com/watch?v=Xg3dAmhFJdE). 

Below, I’ll make a case for what qualities you should look for (and watch out for) in engineers, and how you can assess those qualities in an interview process consisting of a system design interview and a non-LeetCode coding challenge.

This interview process aims to optimize for hiring smart, competent engineers that you don't have to spend an excessive amount of time training (or worse, retraining) to do things that are hard to teach. 

## The interview process

### System design interview

**Questions you're trying to answer during this part:**
...
You can also dig deeper by asking questions like "What protocol is gRPC implemented on top of?" This is a good way to find competent engineers who can peel back abstractions when needed.
...
I don't think this is a wrong or even particularly controversial opinion. Unfortunately, the interview processes of most, if not all, companies I've interviewed with had little to no focus on testing the readability of my code.

I think a good way of assessing this is giving the candidate a take-home or live API design challenge that they can implement, perhaps mocking datastores or whatever other details aren’t reasonable to expect from an interview.
...
Distributed systems are big and complex, and making a lot of mistakes needlessly is expensive.

### Not jumping to solutions quickly enough. 

Distributed systems are big and complex, and you will make mistakes along the way, so at some point, decisions have to be made.
